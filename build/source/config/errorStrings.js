...
var AMOUNT_TEXT = 'Laon amount can not exceed ';
...
var LOAN_AMOUNT_BIGGER = AMOUNT_TEXT + ("" + config_1.config.consumerLoanAmountLimit) + ' eur';
var FAST_LOAN_AMOUNT_BIGGER = AMOUNT_TEXT + ("" + config_1.config.fastLoanAmountLimit) + ' eur';
